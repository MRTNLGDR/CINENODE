@echo off
REM ===========================================================================
REM  CineNode  -  UM CLIQUE FAZ TUDO
REM
...
REM     3. sobe o servidor na porta 8787
...
powershell -NoProfile -ExecutionPolicy Bypass -File "D:\AGENT_SYNC\motor-run.ps1" -Projeto CINENODE %ARGS%
set "RC=%ERRORLEVEL%"
if not "%RC%"=="0" (
  echo.
